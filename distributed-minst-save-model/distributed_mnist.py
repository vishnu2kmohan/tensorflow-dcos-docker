""" distributed_mnist_save_model.py

This script implements MNIST using distributed TensorFlow and saves the Model.
...
def main(server, log_dir, context):
    ...
    num_training_steps = context.get('num_training_steps') or 10000

    # Import data
    data_dir = '{}/mnist'.format(log_dir)
    mnist = input_data.read_data_sets(data_dir, one_hot=True, source_url='file:///mnt/mesos/sandbox/cvdf-datasets/mnist')
