...
python mnist_replica.py \
    --existing_servers \
    --ps_hosts=parameter-server-0-node.devtensorflowinteractive.autoip.dcos.thisdcos.directory:2223,parameter-server-1-node.devtensorflowinteractive.autoip.dcos.thisdcos.directory:2223 \
